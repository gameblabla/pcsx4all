...
INLINE void PSXMEMWRITE32(void)
{
  ...
  CALLFunc((u32)psxMemWrite32_error); /* yyy */
...
// Rt = Rt Merge mem[Rs + Im]
  if (_Rt_)
  {
    ...
    write32((u32)LWL_MASK);
    extern u32 LWL_SHIFT[4];
    write32((u32)LWL_SHIFT);
...
// Rt = Rt Merge mem[Rs + Im]
  ...
  if (_Rt_)
  {
    ...
    write32((u32)LWR_MASK);
    extern u32 LWR_SHIFT[4];
    write32((u32)LWR_SHIFT);
...
// mem[Rs + Im] = Rt Merge mem[Rs + Im]
  ...
  write32((u32)SWL_MASK);
  extern u32 SWL_SHIFT[4];
  write32((u32)SWL_SHIFT);
...
// mem[Rs + Im] = Rt Merge mem[Rs + Im]
  ...
  write32((u32)SWR_MASK);
  extern u32 SWR_SHIFT[4];
  write32((u32)SWR_SHIFT);
