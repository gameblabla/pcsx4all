...
if (IsConst(_Rs_))
{
  ...
  else if ((t & 0x1fe0) == 0 && (t & 0x1fff) != 0)
  {
    MOV32MtoR(HOST_r0, (u32)&psxM[addr & 0x1fffff]);
    pasado=1;
  }
  else if (t == 0x1f80 && addr < 0x1f801000)
  {
...
case 0:
  ...
  {
    case 0:
      CALLFunc((u32)(shift?_gteMVMVA_cv0_mx0_s12_:_gteMVMVA_cv0_mx0_s0_));
      break;
    case 1:
      CALLFunc((u32)(shift?_gteMVMVA_cv0_mx1_s12_:_gteMVMVA_cv0_mx1_s0_));
      break;
    case 2:
      CALLFunc((u32)(shift?_gteMVMVA_cv0_mx2_s12_:_gteMVMVA_cv0_mx2_s0_));
      break;
    default:
      CALLFunc((u32)(shift?_gteMVMVA_cv0_mx3_s12_:_gteMVMVA_cv0_mx3_s0_));
  }
  break;
case 1:
  switch(mx)
  {
    case 0:
      CALLFunc((u32)(shift?_gteMVMVA_cv1_mx0_s12_:_gteMVMVA_cv1_mx0_s0_));
      break;
    case 1:
      CALLFunc((u32)(shift?_gteMVMVA_cv1_mx1_s12_:_gteMVMVA_cv1_mx1_s0_));
      break;
    case 2:
      CALLFunc((u32)(shift?_gteMVMVA_cv1_mx2_s12_:_gteMVMVA_cv1_mx2_s0_));
      break;
    default:
      CALLFunc((u32)(shift?_gteMVMVA_cv1_mx3_s12_:_gteMVMVA_cv1_mx3_s0_));
  }
  break;
case 2:
  switch(mx)
  {
    case 0:
      CALLFunc((u32)(shift?_gteMVMVA_cv2_mx0_s12_:_gteMVMVA_cv2_mx0_s0_));
      break;
    case 1:
      CALLFunc((u32)(shift?_gteMVMVA_cv2_mx1_s12_:_gteMVMVA_cv2_mx1_s0_));
      break;
    case 2:
      CALLFunc((u32)(shift?_gteMVMVA_cv2_mx2_s12_:_gteMVMVA_cv2_mx2_s0_));
      break;
    default:
      CALLFunc((u32)(shift?_gteMVMVA_cv2_mx3_s12_:_gteMVMVA_cv2_mx3_s0_));
  }
  break;
default:
  switch(mx)
  {
    case 0:
      CALLFunc((u32)(shift?_gteMVMVA_cv3_mx0_s12_:_gteMVMVA_cv3_mx0_s0_));
      break;
    case 1:
      CALLFunc((u32)(shift?_gteMVMVA_cv3_mx1_s12_:_gteMVMVA_cv3_mx1_s0_));
      break;
    case 2:
      CALLFunc((u32)(shift?_gteMVMVA_cv3_mx2_s12_:_gteMVMVA_cv3_mx2_s0_));
      break;
    default:
      CALLFunc((u32)(shift?_gteMVMVA_cv3_mx3_s12_:_gteMVMVA_cv3_mx3_s0_));
  }
  }
#ifdef REC_USE_GTE_ASM_FUNCS
  if (saveregs)
