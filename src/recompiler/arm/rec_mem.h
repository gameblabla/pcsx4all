...
static void recMemRead8_direct(void)
{
  ...
  {
    u32 offset=((((u32)(psxHwRead8) - ((u32)(armPtr) + (8))) >> 2) & 0xFFFFFF);  // bcs psxHwRead8
    write32(BCS_FWD_(offset));
  }
...
static void recMemRead16_direct(void)
{
  ...
  write32(CMP_IMM(HOST_r2,0x01,0x14));		// cmp r2, #0x1000
  {
    u32 offset=((((u32)(psxHwRead16) - ((u32)(armPtr) + (8))) >> 2) & 0xFFFFFF);  // bcs psxHwRead16
    write32(BCS_FWD_(offset));
  }
  MOV32MtoR_regs(HOST_ip,(u32)&psxRegs.psxH);	//  ip=psxH
...
static void recMemRead32_direct(void)
{
  ...
  write32(CMP_IMM(HOST_r2,0x01,0x14));		// cmp r2, #0x1000
  {
    u32 offset=((((u32)(psxHwRead32) - ((u32)(armPtr) + (8))) >> 2) & 0xFFFFFF);  // bcs psxHwRead32
    write32(BCS_FWD_(offset));
  }
  MOV32MtoR_regs(HOST_ip,(u32)&psxRegs.psxH);	//  ip=psxH
