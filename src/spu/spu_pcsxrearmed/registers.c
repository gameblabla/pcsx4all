  ...
  switch(r)
  {
    ...
    */
    ...
    case H_Reverb+2   :
      goto rvbd;
    case H_Reverb+4   :
      spu.rvb->IIR_ALPHA=(short)val;
      break;
    case H_Reverb+6   :
      spu.rvb->ACC_COEF_A=(short)val;
      break;
    case H_Reverb+8   :
      spu.rvb->ACC_COEF_B=(short)val;
      break;
    case H_Reverb+10  :
      spu.rvb->ACC_COEF_C=(short)val;
      break;
    case H_Reverb+12  :
      spu.rvb->ACC_COEF_D=(short)val;
      break;
    case H_Reverb+14  :
      spu.rvb->IIR_COEF=(short)val;
      break;
    case H_Reverb+16  :
      spu.rvb->FB_ALPHA=(short)val;
      break;
    case H_Reverb+18  :
      spu.rvb->FB_X=(short)val;
      break;
    case H_Reverb+20  :
      goto rvbd;
    case H_Reverb+22  :
    ...
    case H_Reverb+58  :
      goto rvbd;
    case H_Reverb+60  :
      spu.rvb->IN_COEF_L=(short)val;
      break;
    case H_Reverb+62  :
      spu.rvb->IN_COEF_R=(short)val;
      break;
  }
  return;
